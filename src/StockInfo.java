...
public class StockInfo {
	...
	public List<Double> getProfitInfo(double initialInvestment) {
		...
		for (int i = 0; i < history.size(); i++) {
			...
			// If the leftover amount is enough to buy more stocks, execute the command
